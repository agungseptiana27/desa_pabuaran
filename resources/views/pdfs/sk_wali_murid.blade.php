...
<body>
    ...
    <div class="content">
        ...
        <div class="identity">
            <div class="identity-row">
                ...
                <div class="identity-colon">:</div>
                {{-- <div class="identity-value">{{ $surat->data_surat['blok'] }}
            </div> --}}
        </div>
        <div class="identity-row">
    ...
    <div class="identity-row">
        ...
        <div class="identity-colon">:</div>
        {{-- <div class="identity-value">{{ $surat->data_surat['desa'] }}
    </div> --}}
    </div>
    <div class="identity-row">
        <div class="identity-label">Kecamatan</div>
        <div class="identity-colon">:</div>
        {{-- <div class="identity-value">{{ $surat->data_surat['kecamatan'] }}
    </div> --}}
    </div>
    <div class="identity-row">
        <div class="identity-label">Kabupaten</div>
        <div class="identity-colon">:</div>
        {{-- <div class="identity-value">{{ $surat->data_surat['kabupaten'] }}
    </div> --}}
    </div>
    </div>
    </div>
