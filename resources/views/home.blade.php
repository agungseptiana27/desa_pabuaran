    ...
    <div class="container mx-auto px-10">
        <div class="bg-[#FFFDF7] px-4 md:px-7 lg:px-9">
            <div class="container mx-auto" data-aos="fade-up" data-aos-duration="1200">
                <h1 class="text-[#0D6630] font-bold text-center text-2xl md:text-4xl mb-2">Administrasi Persuratan</h1>
                <h5 class="text-[#000000] font-medium text-center text-xl md:text-xl">
                    Kegiatan pengelolaan seluruh bentuk surat-menyurat <br>
                    yang terjadi di lingkungan pemerintahan desa.
                </h5>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 md:gap-15 md:justify-center">
                    ...
                    <div class="bg-white rounded-lg hover:shadow-xl transition-shadow duration-300 overflow-hidden text-center md:text-start"
                        ...
                        <div class="p-4 md:p-6">
                            <!-- Icon -->
                            <div class="w-[154px] rounded-xl flex items-center justify-center mb-3 md:mb-4 mx-auto md:mx-0"
                                style="background-color: '{{ $suratType->bg_color }}';">
                                <img src="{{ $suratType->icon }}" alt="Ikon {{ $suratType->nama_surat }}"
                                    class="max-w-[154px] max-h-[150px] object-contain" />
                            </div>
                            ...
                            <div>
                                <a href="{{ $suratType->route }}"
                                    class="inline-block px-4 py-2 md:px-6 md:py-2 bg-[#118840] text-white text-sm md:text-base rounded-md hover:bg-green-800 transition-colors duration-300">
                                    Ajukan Sekarang
                                </a>
                            </div>
                        </div>
...
<!-- Profil Desa Section -->
<section id="profil-desa" class="bg-[#FFFDF7] py-10 md:py-16 mt-10">
    <div class="container mx-auto px-4 md:px-6 lg:px-8">

        <!-- Title -->
        <h1 class="text-2xl md:text-4xl font-bold text-[#0D6630] mb-8 text-center md:text-center">
            Profil Desa
        </h1>
        ...
        <div class="flex flex-col md:flex-row items-center justify-between gap-10 md:gap-16">
            ...
            <div class="w-full md:w-1/2 flex justify-center" data-aos="fade-right" data-aos-duration="1200">
                <div class="rounded-lg overflow-hidden w-full max-w-md">
                    <img src="{{ asset('images/profile_desa.png') }}" alt="icon profil desa"
                        class="w-full h-auto object-cover" />
                </div>
            </div>

            <!-- Right column - Text content -->
            <div class="w-full md:w-1/2 space-y-4 md:pl-6" data-aos="fade-left" data-aos-duration="1200">
                <h2 class="text-xl md:text-2xl font-bold text-[#0D6630]">Desa Pabuaran</h2>
                <p class="text-black text-sm md:text-base leading-relaxed">
                    Pabuaran di Subang adalah sebuah kecamatan di Kabupaten Subang, Jawa Barat,
                    yang terdiri dari beberapa desa, seperti Desa Pabuaran itu sendiri, Desa Kadawung,
                    dan Desa Siluman. Kecamatan ini memiliki mayoritas penduduk yang bermata pencaharian
                    sebagai petani dan juga bekerja di sektor industri dan perdagangan. Selain itu, di Pabuaran
                    terdapat Stasiun Pabuaran yang kini difungsikan sebagai pos pengontrolan lalu lintas kereta api.
                </p>

                <!-- Tombol di bawah paragraf -->
                <a href="{{ route('profile-desa') }}" target="_blank"
                    class="inline-flex bg-[#0D6630] text-white hover:bg-[#0D6630] hover:text-white border border-[#0D6630] py-2 px-4 md:px-6 rounded-lg font-medium text-sm md:text-base transition duration-300 items-center">
            ...
            <div class="w-full md:w-1/2 space-y-4 text-center md:text-left order-1 md:order-2" data-aos="fade-left"
                ...
                <div>
                    <a href="{{ route('pengaduan.create') }}"
                        class="inline-flex text-white bg-[#118840] hover:bg-green-900 py-2 px-4 md:px-6 rounded-lg font-medium text-sm md:text-base transition duration-300 items-center">
...
<section id="kabar-desa" class="bg-[#FFFDF7] py-16 mt-15">
    <div class="container mx-auto px-10">
        <div class="text-center mb-12" data-aos="fade-up" data-aos-duration="1200">
            <h2 class="text-4xl font-bold text-[#0D6630] mb-4">Kabar Desa</h2>
            <p class="text-[#676767] max-w-2xl mx-auto">
                Tetap terhubung dengan perkembangan terkini di Desa Pabuaran. Simak berbagai berita dan
                informasi
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="bg-white rounded-lg overflow-hidden transition duration-300 hover:shadow-lg" data-aos="fade-up"
        ...
        <div class="text-center mt-12" data-aos="fade-up" data-aos-duration="1200">
            <a href="{{ route('kabar-desa.index') }}" target="_blank"
                class="bg-[#118840] text-white py-3 px-8 rounded-lg hover:bg-green-900 transition duration-300 inline-flex items-center">
...
<section id="anggaran-desa" class="py-12 bg-[#FFFDF7]">
    <div class="container mx-auto px-4">
        <!-- Judul & Deskripsi -->
        <div class="text-center mb-10" data-aos="fade-up" data-aos-duration="1200">
            <h2 class="text-3xl font-bold text-[#0D6630]">Anggaran Desa</h2>
            <p class="text-gray-600 mt-2 max-w-2xl mx-auto">
                Berikut adalah laporan singkat anggaran desa yang mencakup total pemasukan, pengeluaran, dan selisih
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <div class="flex justify-center" data-aos="fade-left" data-aos-duration="1200" data-aos-delay="600">
                <img src="{{ asset('images/anggaran_desa.png') }}" alt="Foto Kepala Desa"
                    class="rounded-2xl shadow-lg w-full max-w-xs object-cover">
            </div>

            <!-- Kolom Kiri: Statistik Anggaran -->
            <div class="space-y-6">
                <h3 class="text-lg font-bold text-green-600">Total Pemasukan</h3>
                <div class="bg-white p-6 rounded-xl shadow text-center" data-aos="zoom-in" data-aos-duration="1200">
                    <p class="text-2xl font-bold angka" data-target="{{ $pemasukan }}">Rp. 0</p>
                </div>
                <h3 class="text-lg font-bold text-red-600">Total Pengeluaran</h3>
                <div class="bg-white p-6 rounded-xl shadow text-center" data-aos="zoom-in" data-aos-duration="1200"
                    data-aos-delay="200">
                    <p class="text-2xl font-bold angka" data-target="{{ $pengeluaran }}">Rp. 0</p>
                </div>
                <h3 class="text-lg font-bold text-yellow-600">Selisih</h3>
                <div class="bg-white p-6 rounded-xl shadow text-center" data-aos="zoom-in" data-aos-duration="1200"
                    data-aos-delay="400">

                    <p class="text-2xl font-bold angka" data-target="{{ $selisih }}">Rp. 0</p>
                </div>
            </div>
...
<section class="galeri-desa bg-[#FFFDF7] py-16 mt-10">
    <div class="container mx-auto px-4">
        <div class="text-center mb-12" data-aos="fade-up" data-aos-duration="1200">
            ...
            <p class="text-[#676767] max-w-2xl mx-auto">
                Jelajahi momen-momen indah dan kegiatan bermakna di Desa Pabuaran melalui koleksi foto kami.
            </p>
        </div>
                    ...
                    <div class="space-y-6">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">Jl. Raya Pabuaran No. 207
                                    Desa Pabuaran Kecamatan Pabuaran
                                    Kabupaten Subang Kode pos 45251</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">pemerintah@desapabuaran.id</p>
                            </div>
                        </div>
