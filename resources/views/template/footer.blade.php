<footer class="bg-[#0D6630] text-white">
        ...
        <div class="grid md:grid-cols-3 gap-8">
            ...
            <div class="flex items-start gap-4">
                ...
                <div class="flex-shrink-0">
                    <img src="{{ asset('images/logo/logo_footer.png') }}" alt="Logo Desa"
                        class="w-20 h-20 rounded-lg bg-white p-1">
                </div>

                <!-- Teks Profil -->
                <div>
                    <h3 class="text-xl font-bold mb-2">Desa Pabuaran</h3>
            ...
            <div class="mx-0 md:mx-auto">
                ...
                <ul class="space-y-3">
                    ...
                    <li><a href="{{ route('pengaduan.create') }}"
                            class="text-gray-300 hover:text-white transition duration-300">Pengaduan</a></li>
                </ul>
            </div>
        ...
        <div class="border-t border-gray-700 mt-10">
            <div class="flex justify-center items-center py-4">
                <p class="text-gray-400 text-center">
                    &copy; 2025 Desa Pabuaran. Hak Cipta Dilindungi.
                </p>
            </div>
        </div>
    </div>
