        ...
        <div class="max-w-6xl mx-auto">
            ...
            <div class="mb-8">
                <div class="flex flex-wrap justify-center gap-3">
                    <button class="px-5 py-2 bg-[#0D6630] text-white rounded-xl hover:bg-green-900 hover:text-white transition active"
                        onclick="filterGallery('all')">
                        Semua
                    </button>
                    @foreach ($kategori as $kat)
                    <button
                        class="px-5 py-2 bg-gray-200 text-gray-700 rounded-xl hover:bg-[#0D6630] hover:text-white transition"
                    ...
                    <div class="relative overflow-hidden rounded-lg shadow-md group">
                        ...
                        <div
                            ...
                            <div class="absolute bottom-0 left-0 p-4 w-full">
                                ...
                                <span
                                    class="inline-block mt-2 px-3 py-1 bg-[#0D6630] text-white text-xs rounded-full">{{ $item->kategori->nama_kategori ?? 'Tanpa Kategori' }}</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="mt-10 text-center">
                <button id="loadMoreBtn"
                    class="px-6 py-3 bg-[#0D6630] text-white rounded-lg hover:bg-green-900 transition shadow-md">
                    Lihat Lebih Banyak
                </button>
            </div>
            @endif
...
function filterGallery(category) {
    ...
    buttons.forEach(button => {
        button.classList.remove('bg-[#0D6630]', 'text-white', 'active');
    ...
    activeButton.classList.add('bg-[#0D6630]', 'text-white', 'active');
