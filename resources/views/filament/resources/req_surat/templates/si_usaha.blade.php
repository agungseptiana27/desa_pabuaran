...
<div class="p-4 bg-white rounded shadow dark:text-gray-800">
    ...
    <div class="header text-center mb-4">
        <div class="title text-xs font-bold underline mt-4 mb-1" style="text-transform: uppercase">
            {{ $record->subSuratType->suratType->nama_surat ?? 'SURAT KETERANGAN IZIN USAHA' }}
        </div>
    ...
    <p class="pl-8 mb-4 text-xs">Surat izin usaha ini berlaku sejak tanggal ditetapkan dan dapat digunakan untuk melengkapi keperluan administrasi perizinan, pengajuan kredit, maupun kebutuhan hukum lainnya. Demikian surat izin usaha ini diberikan agar dapat digunakan sebagaimana mestinya. Apabila di kemudian hari terdapat hal-hal yang tidak sesuai, surat ini dapat ditinjau kembali. Demikian surat keterangan ini dibuat dengan sebenarnya, untuk dapat digunakan sebagaimana mestinya oleh yang bersangkutan.</p>
