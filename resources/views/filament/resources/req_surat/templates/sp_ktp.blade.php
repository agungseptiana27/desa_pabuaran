...
<div class="p-4 bg-white rounded shadow dark:text-gray-800">
    ...
    <div class="header text-center mb-4">
        <div class="title text-xs font-bold underline mt-4 mb-1" style="text-transform: uppercase">
            {{ $record->subSuratType->suratType->nama_surat ?? 'SURAT KETERANGAN KTP' }}
        </div>
    ...
    <p class="pl-8 mb-4 text-xs">Bahwa yang bersangkutan adalah benar warga kami dan bermaksud mengurus pembuatan Kartu Tanda Penduduk (KTP) baru/perpanjangan/perubahan sesuai dengan ketentuan yang berlaku. Surat pengantar ini dibuat untuk melengkapi syarat administrasi pengurusan KTP di Dinas Kependudukan dan  Pencatatan Sipil Kabupaten Subang.. Demikian surat keterangan ini dibuat dengan sebenarnya, untuk dapat digunakan sebagaimana mestinya oleh yang bersangkutan.</p>
