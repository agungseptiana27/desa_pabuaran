...
<div class="p-4 bg-white rounded shadow dark:text-gray-800">
    ...
    <div class="header text-center mb-4">
        <div class="title text-xs font-bold underline mt-4 mb-1" style="text-transform: uppercase">
            {{ $record->subSuratType->suratType->nama_surat ?? 'SURAT KETERANGAN TIDAK MAMPU BPJS' }}
        </div>
    ...
    <p class="pl-8 mb-4 text-xs">Bahwa yang bersangkutan adalah warga Desa Pabuaran yang termasuk kategori keluarga kurang mampu dan layak untuk diajukan sebagai peserta Program Bantuan Iuran (PBI) Jaminan Kesehatan Nasional melalui BPJS Kesehatan. Surat ini dibuat untuk melengkapi persyaratan administrasi pendaftaran PBI BPJS Kesehatan dan dapat digunakan sebagaimana mestinya.. Demikian surat keterangan ini dibuat dengan sebenarnya, untuk dapat digunakan sebagaimana mestinya oleh yang bersangkutan.</p>
