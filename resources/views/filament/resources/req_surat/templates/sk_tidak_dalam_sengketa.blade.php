...
<div class="p-4 bg-white rounded shadow dark:text-gray-800">
    ...
    <div class="header text-center mb-4">
        <div class="title text-xs font-bold underline mt-4 mb-1" style="text-transform: uppercase">
            {{ $record->subSuratType->suratType->nama_surat ?? 'SURAT KETERANGAN TIDAK DALAM SENGKETA' }}
        </div>
    ...
    <div class="content text-justify text-xs">
        ...
        <p class="mb-2 text-xs">Bahwa benar tanah tersebut adalah milik yang bersangkutan dan sampai dengan saat diterbitkannya surat keterangan ini, tanah tersebut tidak dalam sengketa dengan pihak manapun, baik secara perdata maupun pidana. Surat keterangan ini dibuat untuk memenuhi kebutuhan administrasi dalam hal jual beli, pengurusan sertifikat, pinjaman bank, maupun keperluan lainnya yang sah menurut hukum.</p>
